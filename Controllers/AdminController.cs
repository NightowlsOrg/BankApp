...
public class AdminController : Controller
{
    ...
    public async Task<IActionResult> ListaKunder()
    {
        ...
        var viewModel = kunder.Select(k => new KundViewModel { KundId = k.KundId, IsAdmin =k.IsAdmin, Personnummer = k.Personnummer, Förnamn = k.Förnamn, Efternamn = k.Efternamn, Adress = k.Adress, Postnummer = k.Postnummer, Postort = k.Postort, Tele = k.Tele, Epost = k.Epost, Lösenord = k.Lösenord });
        return View(kunder);
    }
   ...
   public async Task<IActionResult> Delete(Guid kundId)
   {
       ...
       return View(new KundViewModel { KundId = kund.KundId, IsAdmin = kund.IsAdmin, Personnummer = kund.Personnummer, Förnamn = kund.Förnamn, Efternamn = kund.Efternamn, Adress = kund.Adress, Postnummer = kund.Postnummer, Postort = kund.Postort, Tele = kund.Tele, Epost = kund.Epost, Lösenord = kund.Lösenord });
   }
